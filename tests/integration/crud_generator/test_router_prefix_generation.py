...
class TestRouterPrefixGeneration:
    ...
    def test_server_file_integration_generates_correct_prefixes(self):
        ...
        mock_server_content = '''from app.domains.communication.webhooks.api.routers import (
    webhook_router,
)
...
def create_test_server_content() -> str:
    ...
    return '''from app.domains.communication.webhooks.api.routers import webhook_router
